...
import type { PipetteCreatePayload, PipetteListItem, BulkRoomMoveRequest } from "./types";
...
export async function bulkMovePipettes(payload: BulkRoomMoveRequest): Promise<{ moved_ids: number[] }> {
